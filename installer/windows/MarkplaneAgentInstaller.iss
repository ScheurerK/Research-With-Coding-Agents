#define MyAppName "Research With Coding Agents Agent Tools"
...
OutputDir=Output
OutputBaseFilename=ResearchWithCodingAgentsAgentSetup-v0.1.0
Compression=lzma2
...
Source: "..\..\packages\agent-adapters\templates\*"; DestDir: "{app}\agent-config-templates"; Flags: ignoreversion recursesubdirs createallsubdirs
