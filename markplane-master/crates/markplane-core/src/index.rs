...
impl Project {
    ...
    pub fn generate_root_index(&self) -> Result<()> {
        ...
        self.write_project_file("INDEX.md", &content)?;
        Ok(())
    }
    ...
    pub fn generate_backlog_index(&self) -> Result<()> {
        ...
        self.write_project_file("backlog/INDEX.md", &content)?;
        Ok(())
    }
    ...
    pub fn generate_roadmap_index(&self) -> Result<()> {
        ...
        self.write_project_file("roadmap/INDEX.md", &content)?;
        Ok(())
    }
    ...
    pub fn generate_plans_index(&self) -> Result<()> {
        ...
        self.write_project_file("plans/INDEX.md", &content)?;
        Ok(())
    }
    ...
    pub fn generate_notes_index(&self) -> Result<()> {
        ...
        self.write_project_file("notes/INDEX.md", &content)?;
        Ok(())
    }
