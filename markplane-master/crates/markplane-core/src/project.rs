...
// â”€â”€ Patch<T> â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Per-type update structs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
thread_local! {
    static PROJECT_LOCK_DEPTH: RefCell<HashMap<PathBuf, usize>> = RefCell::new(HashMap::new());
}

/// Exclusive project-wide lock for operations that mutate `.markplane/` files.
...
impl Project {
    ...
    /// Acquire an exclusive OS-level lock for this Markplane project.
    ///
    /// The lock is advisory and process-wide. All Markplane mutating entrypoints
    /// use the same `.markplane/.lock` file so CLI, MCP, hooks, and the web UI
    /// serialize writes for a project.
    ...
    /// Run `action` while holding the project-wide lock.
    ///
    /// Calls are reentrant within the same thread so high-level operations can
    /// safely call lower-level helpers that also require the project lock.
    pub fn with_project_lock<T>(&self, action: impl FnOnce() -> Result<T>) -> Result<T> {
        let key = self.lock_key();
        let nested = PROJECT_LOCK_DEPTH.with(|depth| {
        ...
        let guard = self.lock_project()?;
        PROJECT_LOCK_DEPTH.with(|depth| {
            depth.borrow_mut().insert(key.clone(), 1);
        });
        let result = action();
        PROJECT_LOCK_DEPTH.with(|depth| {
    ...
    /// Write a file relative to `.markplane/` while holding the project lock.
    pub fn write_project_file(&self, relative_path: impl AsRef<Path>, content: &str) -> Result<()> {
    ...
    pub fn save_config(&self, config: &Config) -> Result<()> {
        ...
        self.write_project_file("config.yaml", &yaml)
    }

    // â”€â”€ ID Management â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Template Resolution â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ CRUD Operations â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    pub fn create_task(
        ...
        self.with_project_lock(|| write_new_file(&path, &content))?;
    ...
    /// read-modify-write cycle â€” see [`lock_item`] and [`lock_items`].
    ...
    ///
    /// Writes through the project-wide lock for serialized Markplane mutations.
    ...
    // â”€â”€ Typed Update Methods â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Move / Reorder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    pub fn move_item(&self, id: &str, directive: MoveDirective) -> Result<()> {
        ...
        if prefix != IdPrefix::Task {
            return Err(MarkplaneError::Config(format!(
                "{} is not a task â€” only tasks support positioning",
                id
            )));
        }
        ...
        match new_pos {
            ...
            None => {
                // No room for a fractional key â€” normalize the group with the
    ...
    // â”€â”€ Documentation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
mod tests {
    ...
    // â”€â”€ Createâ†’roundtrip byte-identity â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fn test_create_roundtrip_byte_identical() {
        ...
        // Read and immediately write back â€” should produce identical bytes
        let doc: MarkplaneDocument<Task> = project.read_item(&task.id).unwrap();
        project.write_item(&task.id, &doc).unwrap();
        ...
        assert_eq!(
            ...
            "create output must be byte-identical to readâ†’write roundtrip"
        );
    ...
    // â”€â”€ Status updates for Epic, Plan, Note types â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ find_blocked_items â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fn test_create_task_with_emoji_title() {
        ...
        assert_eq!(item.title, "Fix login bug ðŸ”¥ðŸš€");
        // Read it back and verify
        let doc: MarkplaneDocument<Task> = project.read_item(&item.id).unwrap();
        assert_eq!(doc.frontmatter.title, "Fix login bug ðŸ”¥ðŸš€");
    }

    // â”€â”€ Title length validation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ body via typed update methods â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ unarchive_item â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ is_archived â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ apply_tag_changes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fn test_apply_tag_changes_remove_then_add_same() {
        let mut tags = vec!["a".to_string(), "b".to_string()];
        // Remove "a" then re-add "a" â€” should still have "a" (remove first, then add)
    ...
    // â”€â”€ update_epic â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ update_plan â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ update_note â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ update_item (generic dispatch) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ move_item tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    #[test]
    fn test_project_lock_serializes_threads() {
        let (_tmp, project) = setup_project();
        let guard = project.lock_project().unwrap();
        ...
        assert!(
            rx.recv_timeout(std::time::Duration::from_millis(150))
                .is_err(),
            "second project lock should wait while the first lock is held"
        );

        drop(guard);
        rx.recv_timeout(std::time::Duration::from_secs(2))
            .expect("second project lock should proceed after release");
        handle.join().unwrap();
    }
    #[test]
    fn test_sync_all_uses_project_lock() {
        let (_tmp, project) = setup_project();
        let guard = project.lock_project().unwrap();
        let root = project.root().to_path_buf();
        let (tx, rx) = std::sync::mpsc::channel();
        ...
        assert!(
            rx.recv_timeout(std::time::Duration::from_millis(150))
                .is_err(),
            "sync_all should wait while the project lock is held"
        );

        drop(guard);
        rx.recv_timeout(std::time::Duration::from_secs(2))
            .expect("sync_all should proceed after the project lock is released");
        handle.join().unwrap();
    }
